...
export default function Index() {
  return (
    <>
      <SchemaOrg
        type="WebSite"
        title="트립닷컴 할인코드 및 쿠폰 4월 - 항공권 및 일본 적용"
        description="2026년 4월 최신 트립닷컴 할인코드 및 쿠폰 총정리. 항공권 3% 할인, 호텔 최대 12% 할인, 일본 여행 특별 프로모션까지 지금 바로 확인하세요."
        url="/"
      ...
      <section className="hero-section relative overflow-hidden">
        ...
        <div className="container relative py-16 md:py-24 text-center">
          <span className="badge-discount mb-4 inline-block text-sm">2026년 4월 업데이트</span>
      ...
      <section className="container py-12 animate-fade-in">
        <h2 className="section-title text-center">📋 2026년 4월 트립닷컴 할인코드 요약</h2>
