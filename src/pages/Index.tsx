  ...
  return (
    <>
      <SchemaOrg
        type="WebSite"
        title="트립닷컴 할인코드 항공권"
        description="6월 트립닷컴 할인코드 항공권 총정리! 트립닷컴 항공권 할인코드부터 호텔 할인코드까지, 지금 바로 쓸 수 있는 트립닷컴 할인쿠폰을 카테고리별로 정리했습니다. 매월 업데이트되는 트립닷컴 할인코드들을 확인해보세요!"
        url="/"
      ...
      <section className="hero-section relative overflow-hidden">
        ...
        <div className="container relative py-16 md:py-24 text-center">
          <span className="badge-discount mb-4 inline-block text-sm">2026년 6월 업데이트</span>
      ...
      <section className="container py-12 animate-fade-in">
        <h2 className="section-title text-center">📋 2026년 6월 트립닷컴 할인코드 요약</h2>
      ...
      <section className="container py-12">
        ...
        <div className="prose max-w-none text-muted-foreground space-y-4">
          ...
          <p>
            2026년 6월 현재, 트립닷컴에서는 메가세일, 슈퍼 데스티네이션 일본, GO 차이나, GO 태국 등 다양한 프로모션을 동시에 진행하고 있습니다. 또한 삼성카드, 롯데카드 등 카드사 제휴 할인을 함께 적용하면 더욱 큰 할인 혜택을 누릴 수 있습니다.
          </p>
          <p>
