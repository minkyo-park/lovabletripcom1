...
const faqItems = [
  ...
  { question: "트립닷컴 메가세일은 언제 진행되나요?", answer: "트립닷컴 메가세일은 보통 연 2~4회 진행되며, 4월, 6월, 9월, 11~12월(블랙프라이데이)에 주로 열립니다. 메가세일 기간에는 항공권 최대 10만원, 호텔 최대 10만원, 액티비티 6% 할인 등 평소보다 파격적인 혜택이 제공됩니다." },
          ...
          <div className="table-container">
            <table>
              ...
              <tbody>
                ...
                <tr><td>4~5월</td><td>봄 여행 시즌</td><td>벚꽃 여행 특가</td><td>일본, 대만</td></tr>
