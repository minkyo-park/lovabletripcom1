...
const flightCoupons = [
  {
    ...
    expiry: "2026년 8월 31일", image: couponFlight,
  ...
  },
  {
    ...
    expiry: "2026년 8월 31일", image: couponThailand,
...
export default function FlightDiscount() {
  return (
    <>
      <SchemaOrg
        type="Article"
        title="트립닷컴 항공권 할인코드 2026년 8월 - 최대 10% 할인"
        description="2026년 8월 최신 트립닷컴 항공권 할인코드 총정리. 전 노선 3% 할인부터 태국 10%, 중국·홍콩·마카오 정액 할인까지 모든 항공권 할인코드를 확인하세요."
        url="/flight-discount"
        breadcrumbs={[
          { name: "홈", url: "/" },
      ...
      <section className="container py-12">
        ...
        <div className="table-container mb-8">
          <table>
            ...
            <tbody>
              <tr><td><CopyBtn code="TRIPH3F" /></td><td className="font-bold text-primary">3% 할인 (한도없음)</td><td>전 세계 모든 노선</td><td>26/08/31</td></tr>
              <tr><td><CopyBtn code="GNVGXDXJQK" /></td><td className="font-bold text-primary">10% 할인</td><td>태국 도착 한정</td><td>26/08/31</td></tr>
              <tr><td><CopyBtn code="VAIPTSTTGD" /></td><td className="font-bold text-primary">19,380원 할인</td><td>광둥 도착 한정</td><td>26/08/31</td></tr>
              <tr><td><CopyBtn code="RHTKAGWUHE" /></td><td className="font-bold text-primary">19,380원 할인</td><td>홍콩 도착 한정</td><td>26/08/31</td></tr>
              <tr><td><CopyBtn code="GNXNCPVJVD" /></td><td className="font-bold text-primary">19,380원 할인</td><td>마카오 도착 한정</td><td>26/08/31</td></tr>
            </tbody>
          </table>
        </div>
      </section>
