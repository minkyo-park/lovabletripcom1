...
const flightCoupons = [
  {
    ...
    expiry: "2026년 5월 31일", image: couponFlight,
  ...
  },
  {
    ...
    expiry: "2026년 5월 31일", image: couponThailand,
...
export default function FlightDiscount() {
  return (
    <>
      <SchemaOrg
        type="Article"
        title="트립닷컴 항공권 할인코드 2026년 5월 - 최대 10% 할인"
        description="2026년 5월 최신 트립닷컴 항공권 할인코드 총정리. 전 노선 3% 할인부터 태국 10%, 중국·홍콩·마카오 정액 할인까지 모든 항공권 할인코드를 확인하세요."
        url="/flight-discount"
        breadcrumbs={[
          { name: "홈", url: "/" },
      ...
      <section className="hero-section py-12 md:py-16 relative overflow-hidden">
        ...
        <div className="container relative text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="badge-discount text-sm">2026년 5월 최신</span>
          </div>
